...
const elementTemplate = (function () {
    const typeName = 'element', id = new IdProp('id'), x = new ScalarProp('x'), y = new ScalarProp('y'), name = new ScalarProp('name'), type = new ScalarProp('type'), properties = [id, x, y, name, type];
    return { typeName, id, x, y, name, type, properties };
})();
const wireTemplate = (function () {
    const typeName = 'wire', src = new ReferenceProp('src'), srcPin = new ScalarProp('srcPin'), dst = new ReferenceProp('dst'), dstPin = new ScalarProp('dstPin'), properties = [src, srcPin, dst, dstPin];
    return { typeName, src, srcPin, dst, dstPin, properties };
})();
const functionchartTemplate = (function () {
    const typeName = 'circuit', x = new ScalarProp('x'), y = new ScalarProp('y'), width = new ScalarProp('width'), height = new ScalarProp('height'), name = new ScalarProp('name'), elements = new ChildArrayProp('elements'), wires = new ChildArrayProp('wires'), functioncharts = new ChildArrayProp('functioncharts'), properties = [x, y, width, height, name, elements, wires, functioncharts];
...
export class Element {
    ...
    set type(value) { this.template.type.set(this, value); }
...
export class Functionchart {
    ...
    get functioncharts() { return this.template.functioncharts.get(this); }
    constructor(context) {
...
export class FunctionchartContext extends EventBase {
    ...
    insertFunctionchart_(functionchart, parent) {
