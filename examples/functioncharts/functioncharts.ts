...
export type InstancerTypes = Functionchart | ImporterElement;
...
export class FunctionchartContext extends EventBase<Change, ChangeEvents>
  ...
  newInstanceForWire(wire: Wire, parent: Functionchart, p: Point) {
    ...
    element.instancer = src as InstancerTypes;
...
class Renderer implements ILayoutEngine {
  ...
  drawFunctionInstanceLink(instance: FunctionInstance) {
    const ctx = this.ctx,
          ...
          p1 = this.outputPinToPoint(instance.instancer, instance.srcPin),
